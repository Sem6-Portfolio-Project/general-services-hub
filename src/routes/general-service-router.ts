...
export class GeneralServiceRouter extends BaseRouter {
  ...
  protected initRoutes = (): void => {
    ...
    this.router.get('/lost-found/item/:id', this.lostFoundItemController.getLostOrFoundItem);
    this.router.get('/lost-found/items', this.lostFoundItemController.getLostOrFoundItems);
    this.router.delete('/lost-found/item/:id', this.lostFoundItemController.deleteLostFoundItem);
  }
}
